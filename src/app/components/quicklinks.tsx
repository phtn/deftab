...
export const Quicklinks = () => (
  <div className="w-full overflow-hidden bg-gradient-to-b from-[#b8b4ac] via-[#c8b9a0] to-[#e1c18e]">
    <div className="grid h-10 w-full grid-cols-4 bg-gray-950">
      <div className="relative col-span-3">
        <div className="absolute h-full w-full bg-gradient-to-b from-[#b8b4ac] via-[#c8b9a0] to-[#e1c18e]" />
      ...
      <div className="relative col-span-1 flex -skew-x-[30deg] justify-end rounded-tl-md rounded-tr-xl bg-gradient-to-b from-[#b8b4ac] via-[#c8b9a0] to-[#e1c18e]">
        <div className="absolute -right-0 size-10 skew-x-[30deg] bg-gray-950" />
        <div className="absolute -right-0 size-10 w-3/4 skew-x-[30deg] rounded-tr-xl bg-gradient-to-b from-[#b8b4ac] via-[#c8b9a0] to-[#e1c18e]" />
      </div>
    </div>

    <div className="relative h-fit w-full bg-gray-950">
      <div className="absolute h-[6rem] w-full rounded-l-2xl rounded-br-2xl bg-gradient-to-b from-[#b8b4ac] via-[#c8b9a0] to-[#e1c18e]" />
